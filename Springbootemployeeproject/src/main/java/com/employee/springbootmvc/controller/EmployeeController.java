...
public class EmployeeController {
	    ...
	    @PostMapping("/submit")
	    public String processEmployeeForm(@Valid @ModelAttribute("employee") EmployeeModel employeeModel, BindingResult bindingResult, Model model) {

	        if (bindingResult.hasErrors())
	        {
	            return "employee-form"; // Return form with error messages
	        }

	        // Save employee or perform other actions
	        employeeService.saveEmployeeData(employeeModel);
	        return "redirect:/getemployeedetails";
	    }
